...
class AttributeController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        flash(('Attribute has been deleted successfully'))->success();
        return redirect()->route('attributes.index');
    ...
    public function store_attribute_value(Request $request)
    {
        ...
        flash(('Attribute value has been inserted successfully'))->success();
    ...
    public function update_attribute_value(Request $request, $id)
    {
        ...
        flash(('Attribute value has been updated successfully'))->success();
        return back();
    }
    ...
    public function destroy_attribute_value($id)
    {
        ...
        flash(('Attribute value has been deleted successfully'))->success();
    ...
    public function store_color(Request $request) {
        ...
        flash(('Color has been inserted successfully'))->success();
