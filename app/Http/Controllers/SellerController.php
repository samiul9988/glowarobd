...
class SellerController extends Controller
{
    ...
    public function reject_seller($id)
    {
        ...
        if ($seller->save()) {
            Cache::forget('verified_sellers_id');
            flash(('Seller verification request has been rejected successfully'))->success();
            return redirect()->route('sellers.index');
        }
        flash(('Something went wrong'))->error();
        return back();
    ...
    public function ban($id)
    {
        ...
        if ($seller->user->banned == 1) {
            ...
            flash(('Seller has been unbanned successfully'))->success();
        } else {
            $seller->user->banned = 1;
            flash(('Seller has been banned successfully'))->success();
        }
