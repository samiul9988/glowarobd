                    ...
                    @auth
                        <div class="" id="login">
                            ...
                            <span class="inline_login">
                                ...
                                @if(isAdmin())
                                    <div>
                                        <a href="{{ route('admin.dashboard') }}" class="text-reset d-inline-block opacity-70 py-2">{{ translate('My Panel')}}</a> / <a href="{{ route('logout') }}" class="text-reset d-inline-block opacity-70 py-2">{{ translate('Logout')}}</a>
                                    </div>
                                @else
                                <div>
                                    <a href="{{ route('dashboard') }}" class="text-reset d-inline-block opacity-70 py-2">{{ translate('My Panel')}}</a> / <a href="{{ route('logout') }}" class="text-reset d-inline-block opacity-70 py-2">{{ translate('Logout')}}</a>
                                </div>
                                @endif
                            </span>
                        </div>
                    @else
                        <div class="" id="login">
                            ...
                            <span class="inline_login">
                                ...
                                <div>
                                    <a href="{{ route('user.login') }}" class="text-reset d-inline-block opacity-70 py-2">{{ translate('Login')}}</a> / <a href="{{ route('user.registration') }}" class="text-reset d-inline-block opacity-70 py-2">{{ translate('Registration')}}</a>
                                </div>
                            </span>
                        </div>
                    @endauth
    ...
    @if ( get_setting('customs_menu_71') !=  null && @intval(json_decode(@get_setting('mega_menu_71')))==1)
        <div class="bg-white border-top border-gray-200 py-1 menu-hide">
            <div class="container">
                ...
                @endphp
                @if ($menus != '')
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center main_menu" id="accordion" data-cehck="<?=$menus?> ">
                        ...
                        <div class="megamenu_wrapper row">
                            <div class="megamenu_column col">
                                ...
                                <div class="megamenu_list">
                                    ...
                                    <ul>
                                        @foreach (@$value["children"] as $key => $value)
                                        <li><a href="{{ url('/').'/'.$value["url"] }}">{{ translate($value["label"]) }}</a></li>
                                        @endforeach
                                    </ul>
                                    @endif
                                    @endif
