...
interface Props {
  data: ProductType[];
  category: CategoryType | FlashDealType;
  link?: string;
}

export default function ShowByCategorySlider({ data, category, link }: Props) {
  ...
  return (
    <div className="relative w-full">
      ...
      <div
        ref={nextRef}
        className={`group absolute top-1/2 z-10 translate-x-1/2 -translate-y-1/2 cursor-pointer rounded-full bg-white p-3 shadow-md md:right-2 lg:right-0 ${
