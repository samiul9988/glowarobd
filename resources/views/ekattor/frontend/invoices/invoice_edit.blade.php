                    ...
                    <div class="card-body">
                                ...
                                <div class="col ml-auto">
                                    <table class="float-right">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-main text-bold">{{translate('Delivery type')}}</td>
                                                <td class="text-right">
                                                    ...
                                                    {{ $order->orderDetails[0]->pickup_point->getTranslation('name') }} ({{ translate('Pickup Point') }})
                                                    @else
                        ...
                        <div id="cart-details">
                            ...
                            <div>
                                ...
                                <div class="d-flex justify-content-between fw-600 mb-2 opacity-70">
                                    <span>{{translate('Reward point discount')}}</span>
                ...
                <div class="pos-footer mar-btm">
                    <div class="d-flex flex-column flex-md-row justify-content-between">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header bord-btm">
                                                <h4 class="modal-title h6">{{translate('Shipping Information')}}</h4>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary btn-styled btn-base-1" data-dismiss="modal" onclick="setShipping()">{{translate('Confirm')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="my-2 my-md-0">
                            <button type="button" class="btn btn-primary btn-block" onclick="orderConfirmation()">{{ translate('Update Order') }}</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="new-customer" class="modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-styled btn-base-3" data-dismiss="modal" id="close-button">{{translate('Close')}}</button>
                    <button type="button" class="btn btn-primary btn-styled btn-base-1" id="confirm-address">{{translate('Confirm')}}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="order-confirm" class="modal fade">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom modal-xl">
            <div class="modal-content" id="variants">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-styled btn-base-3" data-dismiss="modal">{{translate('Close')}}</button>
                    <button type="button" onclick="submitOrder('cash')" class="btn btn-styled btn-base-1 btn-primary">{{translate('Comfirm Update')}}</button>
                </div>
            </div>
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
