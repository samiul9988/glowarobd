...
class PickupPointController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($pickup_point->save()) {
            ...
            flash(('PicupPoint has been inserted successfully'))->success();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($pickup_point->save()) {
            ...
            flash(('PicupPoint has been updated successfully'))->success();
            return redirect()->route('pick_up_points.index');
        }
        else{
            flash(('Something went wrong'))->error();
    ...
    public function destroy($id)
    {
        ...
        if(PickupPoint::destroy($id)){
            flash(('PicupPoint has been deleted successfully'))->success();
            return redirect()->route('pick_up_points.index');
        }
        else{
            flash(('Something went wrong'))->error();
