    ...
    <form class="" action="" method="GET">
      <div class="card-header row gutters-5">
        <div class="col text-center text-md-left">
          <h5 class="mb-md-0 h6">{{ ('Pickup Point Orders') }}</h5>
        </div>
        <div class="col-lg-2">
                ...
                @foreach ($orders as $key => $order_id)
                    ...
                    @if($order != null)
                        <tr>
                            ...
                            <td class="text-right">
                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('pick_up_point.order_show', encrypt($order->id)) }}" title="{{ ('View') }}">
