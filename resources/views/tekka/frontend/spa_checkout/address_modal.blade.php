                ...
                <div class="modal-body" style="padding:0">
                    <div class="p-3">
                        ...
                        <div class="row align-items-center mb-3">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" placeholder="Enter your name" name="name" minlength="3" required>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3">
                            <div class="col-md-3">
                        ...
                        <div class="row align-items-center mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="number" class="form-control" placeholder="01xxxxxxxxx" name="phone" x-model="newMobileNumber" title="Phone number should be minimum 11 characters and only contain numbers between [0-9]. e.g. {{ get_setting('helpline_number') }}" required>
                                <span x-show="newMobileNumber.length < 11 || newMobileNumber.length > 11" class="text-danger fw-600">Phone number should be minimum 11 characters and only contain numbers between [0-9]. e.g. {{ get_setting('helpline_number') }}</span>

                            </div>
                        </div>

                        <div class="form-group text-center">
                            <button x-bind:type="(newMobileNumber.length < 11 || newMobileNumber.length > 11) ? 'button' : 'submit'"  x-bind:disabled="(newMobileNumber.length < 11 || newMobileNumber.length > 11)" class="btn btn-sm btn-dark">{{ ('Save')}}</button>
                        </div>
                    </div>
                </div>
            </form>
