                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-raw fs-20 mb-5">
                                <li class="list-group-item py-2">
                                    ...
                                    {{ $customer_package->product_upload }} {{ ('Product Upload')}}
                                </li>
                            </ul>
                            ...
                            <div class="text-center">
                                @if ($customer_package->amount == 0)
                                    <button class="btn btn-primary" onclick="get_free_package({{ $customer_package->id}})">{{ ('Free Package')}}</button>
                                @else
                                    @if (addon_is_activated('offline_payment') )
                                        <button class="btn btn-primary" onclick="select_payment_type({{ $customer_package->id}})">{{ ('Purchase Package')}}</button>
                                    @else
                                        <button class="btn btn-primary" onclick="show_price_modal({{ $customer_package->id}})">{{ ('Purchase Package')}}</button>
                                    @endif
                                @endif
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group text-right">
                        <button type="button" class="btn btn-sm btn-primary transition-3d-hover mr-1" id="select_type_cancel" data-dismiss="modal">{{ ('Cancel')}}</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <form class="" id="package_payment_form" action="{{ route('customer_packages.purchase') }}" method="post">
                    ...
                    <div class="modal-body gry-bg px-3 pt-3">
                        ...
                        <div class="form-group text-right">
                            <button type="button" class="btn btn-sm btn-secondary transition-3d-hover mr-1" data-dismiss="modal">{{ ('cancel')}}</button>
