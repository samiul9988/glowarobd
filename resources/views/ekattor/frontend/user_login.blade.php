        ...
        <div class="profile">
            <div class="container">
                <div class="row bg-white mx-auto align-items-center justify-content-center user_log_holder">
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-4 user_log_left">
                        <img src="{{ static_asset('assets/theme22/frontend/img/log_left_img.png') }}" class="img-fluid" alt="">
                    </div>
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-8 mx-auto">
                        <div class="user_log_form">
                            ...
                            <div class="px-4 py-3 py-lg-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="{{ route('user.registration') }}" class="font-weight-bold">{{ translate('Register Now')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
