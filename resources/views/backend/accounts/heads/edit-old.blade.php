...
<div class="col-lg-7 mx-auto">
    <div class="card" x-data="app()" x-init="get_subheads">
        ...
        <form action="{{ route('heads.update', $head->id) }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('head') is-invalid @enderror" id="head" name="head" placeholder="Enter head" x-model="head" required>
                    @error('head')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
        ...
        <script type="text/javascript">
            function app() {
                return {
                    parent_head: '{{ $head->parent_head }}',
                    sub_head: '{{ $head->sub_head }}',
                    head: '{{ $head->head }}',
                    showSubSelect: false,
                    subheads: {},
