...
@php
	// dd($page);
	if(strtolower($page->slug) == 'about-us'){
		$lang = 'en';
	}
@endphp
@section('content')
...
<div class="card">
	...
	<form class="p-4" action="{{ route('custom-pages.update', $page->id) }}" method="POST" enctype="multipart/form-data">
		...
		<div class="card-body px-0">
					...
					<div class="col-sm-10">
						<div class="input-group d-block d-md-flex">
							@if($page->type == 'custom_page')
								<div class="input-group-prepend"><span class="input-group-text flex-grow-1">{{ route('home') }}/page/</span></div>
            ...
            <div class="form-group row">
				<label class="col-sm-2 col-from-label" for="name">{{ ('Desktop Banner')}}</label>
				<div class="col-sm-10">
					<div class="input-group " data-toggle="aizuploader" data-type="image">
							...
							<input type="hidden" name="desktop_banner" class="selected-files" value="{{ $page->desktop_banner }}">
					</div>
            ...
            <div class="form-group row">
				<label class="col-sm-2 col-from-label" for="name">{{ ('Mobile Banner')}}</label>
				<div class="col-sm-10">
					<div class="input-group " data-toggle="aizuploader" data-type="image">
							<div class="input-group-prepend">
									<div class="input-group-text bg-soft-secondary font-weight-medium">{{ ('Browse') }}</div>
							...
							<div class="form-control file-amount">{{ ('Choose File') }}</div>
							<input type="hidden" name="mobile_banner" class="selected-files" value="{{ $page->mobile_banner }}">
					</div>
					<div class="file-preview">
					</div>
				</div>
		...
		<div class="card-body px-0">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<textarea class="resize-off form-control" placeholder="Meta description" name="meta_description">{{ $page->meta_description }}</textarea>
				</div>
			</div>
