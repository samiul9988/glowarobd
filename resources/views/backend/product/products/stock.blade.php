...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h1 class="mb-0 h6">{{ ('Product Stock') }}</h5>
</div>
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('products.admin.updatestock', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
        <div class="row gutters-5">
            <div class="col-lg-12">
                ...
                <div class="card" style="display: none;">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="name" placeholder="{{ ('Product Name')}}" value="{{ $product->getTranslation('name', $lang) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="unit" placeholder="{{ ('Unit (e.g. KG, Pc etc)') }}" value="{{$product->getTranslation('unit', $lang)}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{ ('Product stock')}}</h5>
                    </div>
                    <div class="card-body">
...
<!--                <div class="card">
            ...
            <div class="col-12">
                <div class="mb-3 text-right">
                    <button type="submit" name="button" class="btn btn-info">{{ ('Update Product Stock') }}</button>
                </div>
            </div>
        </div>
    </form>
