...
class DiscountedProductCollection extends ResourceCollection
{
    /**
    ...
    public function toArray($request)
    {
        $data = $this->collection->map(function($data) {
            return [
                'discount_start' => date('m-d-Y', $data->discount_start_date),
                'discount_end' => date('m-d-Y', $data->discount_end_date),
                'id' => $data->id,
                'slug' => $data->slug,
