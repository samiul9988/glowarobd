...
class StoreStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => 'required_if:mobile,null|nullable|email|max:255|unique:users,email',
            'mobile' => ['required_if:email,null', 'nullable', 'string', 'regex:/^(\+88)?01[3-9]\d{8}$/', 'unique:users,phone'],
            ...
            // Optional
            'job_application_id' => 'nullable|integer|exists:job_post_applications,id',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'mobile.regex' => 'Invalid mobile number. Must be a valid Bangladeshi number (e.g. 01712345678 or +8801712345678).',
            ...
            'job_application_id.exists' => 'The selected job application is invalid.',
        ];
    }
}
