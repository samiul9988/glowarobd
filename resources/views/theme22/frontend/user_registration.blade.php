...
@section('content')
    <section class="gry-bg py-5">
        <div class="profile">
            <div class="container">
                <div class="row bg-white mx-auto align-items-center justify-content-center user_log_holder">
                    <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-4 user_log_left reg_left text-center">
                        <i class="la la-check-circle la-2x"></i>
                        <p class="text-center d-none">ইমার্ট ওয়ে দেশের প্রতিষ্ঠিত একটি অনলাইন শপিং মল এবং সম্পূর্ণ বাংলাদেশের বিনিয়োগ এ একমাত্র পূর্নাঙ্গ ই-কমার্স ওয়েবসাইট। এখানে সব বয়সের ক্রেতারা নিত্যদিনের প্রয়োজনীয় প্রতিটি পণ্যসামগ্রী যেমন, গ্যাজেট, ইলেকট্রনিক্স, গৃহস্থালি সামগ্রী, চামড়াজাত পণ্য, গহনা, বাচ্চাদের বিভিন্ন সামগ্রী, প্রসাধনী ফ্যাশন ও লাইফস্টাইল পন্য থেকে শুরু করে সবকিছুই অত্যন্ত সুলভ মুল্যে ঘরে বসে কেনাকাটা করতে পারে। বাংলাদেশের যেকোনো স্থান থেকে যেকোনো সময়ে ইন্টারনেটের মাধ্যমে অনলাইনে ক্রেতারা তাদের পছন্দনীয় পণ্যের অর্ডার করে এবং ইমার্ট ওয়ে তার নিজস্ব ব্যবস্থাপনায় সারা বাংলাদেশে ক্রেতাদের ডেলিভারী দিয়ে থাকে।</p>
                        <p class="text-center">{{ ('Welcome To Number 1 Beauty eCommerce in Bangladesh') }}</p>
                    </div>
                    <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-8 mx-auto">
                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        {{-- Trap Bot Honeypot Technique--}}
                                        <div class="form-group" style="display: none">
                                            <input type="text" class="form-control" name="agent" id="agent" placeholder="Enter agent id">
                                        </div>
                                        {{-- End Trap Bot --}}
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="{{ route('user.login') }}" class="font-weight-bold">{{ ('Log In')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
