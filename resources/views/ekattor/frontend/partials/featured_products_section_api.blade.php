@php
    $response = Illuminate\Support\Facades\Http::get(url('/').'/api/v2/products?page=1&orderby=rand&limit=18');
@endphp
            ...
            <div class="px-2 py-2 px-md-4 bg-white shadow-sm rounded section_holder">
                <div class="d-flex mb-3 align-items-baseline section_title_holder mx-0">
                    <h3 class="h5 fw-700 mb-0">
                        <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">{{ translate('Your Favourite Ones') }}</span>
                    </h3>
                </div>
                ...
                <div id="btn-fp-load-more-wrapper" class="mx-auto d-flex align-items-center justify-content-center mt-2">
                    <a href="{{ route('search') }}" id="btn-fp-load-more" class="view_btn-ex btn-view-more d-inline-block">{{ translate('Load More') }}<i class="fa-sharp fa-solid fa-right-long ml-1" ></i></a>
                </div>
