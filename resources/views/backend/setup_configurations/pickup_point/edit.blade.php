...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{ ('Update Pickup Point Information')}}</h5>
</div>
            ...
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('pick_up_points.update',$pickup_point->id) }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{ ('Name')}}" id="name" name="name" value="{{ $pickup_point->getTranslation('name', $lang) }}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="address">{{ ('Location')}} <i class="las la-language text-danger" title="{{ ('Translatable')}}"></i></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{ ('Phone')}}" id="phone" name="phone" value="{{ $pickup_point->phone }}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label">{{ ('Pickup Point Status')}}</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="name">{{ ('Pick-up Point Manager')}}</label>
                        <div class="col-sm-9">
