                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{ ('Type')}}</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row">
	                        <label class="col-sm-3 control-label" for="sa_date">{{ ('Date')}}</label>
	                        <div class="col-sm-3">
	                          <input type="date" class="form-control" name="sa_date" placeholder="{{ ('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off" value="{{ date('Y-m-d',$stock_adjust->sa_date)}}">
	                        </div>
	                    </div>
                    </div>
                </div>
