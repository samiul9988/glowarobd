    ...
    <div class="">
        <div class="row ">
            ...
            <div class="col-md-6 mt-3 mt-sm-0 text-center text-md-right">
                <a href="{{ route('addons.create')}}" class="btn btn-primary">{{ ('Install/Update Addon')}}</a>
            </div>
        </div>
    </div>
    <br>
                                ...
                                @forelse(\App\Models\Addon::all() as $key => $addon)
                                    <li class="list-group-item">
                                        <div class="align-items-center d-flex flex-column flex-md-row">
                                            ...
                                            @if (env('DEMO_MODE') != 'On')
                                                <div class="mr-md-3 ml-0">
                                                    <p><small>{{ ('Purchase code')}}: </small>{{ $addon->purchase_code }}</p>
                                                </div>
                                            @endif
                                ...
                                @empty
                                    <li class="list-group-item">
                                        <div class="text-center">
                                            ...
                                            <h5 class="mb-0 h5 mt-3">{{ ('No Addon Installed')}}</h5>
                                        </div>
                                    </li>
                                @endforelse
                            </ul>
