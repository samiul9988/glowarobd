...
<div class="card">
    ...
    <!--                    <td>
                        ...
                        <td class="text-right">
                            ...
                            {{--<a class="btn btn-soft-info btn-icon btn-circle btn-sm" href="{{ route('invoice.download', $stockadjustment->id) }}" title="{{ ('Download Invoice') }}" target="_blank">
                                <i class="las la-download"></i>
                            </a>
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('orders.destroy', $stockadjustment->id)}}" title="{{ ('Delete') }}">
