            ...
            <div class="card">
                <form class="" id="sort_cities" action="" method="GET">
                    <div class="card-header row gutters-5">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="search" name="search" value="{{ request('search') }}" placeholder="{{ ('Type city name & Enter') }}">
                        </div>
                        <div class="col-md-4">
                            <select class="form-control aiz-selectpicker" data-live-search="true" id="state" name="state">
    			...
    			<div class="card-body">
    				<form action="{{ route('cities.store') }}" method="POST">
                        ...
                        <div class="form-group mb-3" style="display: none">
    						...
    						<input type="number" min="0" step="0.01" placeholder="{{ ('Cost')}}" name="cost" class="form-control" value="0" required>
    					</div>
