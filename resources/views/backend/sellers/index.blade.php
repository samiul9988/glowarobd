        ...
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-3 ml-auto">
                <select class="form-control aiz-selectpicker" name="approved_status" id="approved_status" onchange="sort_sellers()">
                    ...
                    <option value="1"  @isset($approved) @if($approved == 'paid') selected @endif @endisset>{{ ('Approved')}}</option>
                    <option value="0"  @isset($approved) @if($approved == 'unpaid') selected @endif @endisset>{{ ('Non-Approved')}}</option>
                </select>
            </div>
            <div class="col-md-3">
