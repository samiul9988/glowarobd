...
<section class="pb-5 track_order_page">
    <div class="container text-left ">
        <div class="row px-0 px-xl-5  mt-2 mt-md-5">
                ...
                <form class="" action="{{ route('orders.track') }}" method="GET" enctype="multipart/form-data">
                    <div class="bg-white rounded">
                        ...
                        <div class="form-box-content p-3">
                            <div class="heading fw-600   mb-3">
                                 {{ ('Check Your Order Status')}}
                            </div>
                            <div class="form-group row m-0">
                                <input type="text" class="form-control mb-3 col-12 col-xl-7 col-xxl-8" placeholder="{{ ('Enter Order Code')}}" name="order_code" required>
                                <button type="submit" class="btn btn-primary col-12 col-xl-5 col-xxl-4 ">{{ ('Track Order')}}</button>
                            </div>
            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="bg-white rounded ">
                    <div class="modal-header border-0 align-items-baseline ml-sm-3 " >
                        ...
                        <div>
                            <h6 class="modal-title mb-1" id="exampleModalLabel">
                                {{ ('Order Details')}}
                                <span class="order-status d-inline d-sm-none">Picked Up</span>
                                #{{ $order->code }}
                                <span class="order-status d-none d-sm-inline">Picked Up</span>
                            </h6>
                            <p>
                                <span class="">
                ...
                @endphp
                    ...
                    <div class="modal-body gry-bg px-3 pb-4 pt-0" style="overflow-x: clip;">
                    ...
                    <div class="d-none d-md-block order-details">
                        <div class="pb-4">
                            <div class="row gutters-5 text-center aiz-steps ">
                                ...
                                <div class="col  @if($status == 'pending') done @elseif($status == 'picked_up' || $status == 'on_the_way' || $status == 'delivered' || $status == 'cancelled') done @endif">
                                    <div class="icon">
                                    @if($status == 'pending')
