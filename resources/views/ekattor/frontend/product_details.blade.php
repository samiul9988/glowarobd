...
@endsection
<?php //dd($detailedProduct->flash_deal_product->quantity)?>
@section('content')
    <section class="mb-4 pt-3 product_details">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="">
                                                <strong class="h2 fw-600 text-primary">
                                                    {{ single_price(min(get_all_discount_prices($detailedProduct))); }}
                                                </strong>
                                                @if($detailedProduct->unit != null)
                            ...
                            @php
                                $appPrice = getMinimumPriceByVariant($detailedProduct, $detailedProduct->stocks->first(), 'app', 1, null);
                                $webPrice = getMinimumPriceByVariant($detailedProduct, $detailedProduct->stocks->first(), 'web', 1, null);
                            @endphp
                            ...
                            @if($detailedProduct->getTranslation('short_description')!=NULL)
                            <hr>
                            <div class="row align-items-center">
                                <div class="col-12">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="product-quantity d-flex align-items-center">
                                            ...
                                            <div class="avialable-amount opacity-60">
                                                ...
                                                (<span id="available-quantity">{{ $detailedProduct->flash_deal_product->quantity }}</span> {{ translate('available')}})
                            ...
                            <div class="mt-3">
                                ...
                                <button type="button" class="btn btn-soft-primary pre-order fw-600 d-none" onclick="buyNow()">
                                    <i class="la la-cart-arrow-down"></i> {{ translate('Pre-order Now')}}
                                </button>
                                <br>
                ...
                <div class="col-xl-12 order-0 order-xl-1">
                    <div class="bg-white mb-3 shadow-sm rounded">
                        <div class="nav border-bottom aiz-nav-tabs">
                            ...
                            @endif
                                <a href="#tab_default_4" data-toggle="tab" class="p-3 fs-16 fw-600 text-reset">{{ translate('Reviews & Rating')}}</a>
                        </div>
                            ...
                            <div class="tab-pane fade" id="tab_default_4">
                                ...
                                <div class="customars-ratting">
                                    <div class="product-headding">
                                        <h1>Ratings & Reviews of {{ $detailedProduct->getTranslation('name') }}</h1>
                                    </div>
                                        ...
                                        <div class="pt-4">
                                            ...
                                            <form class="form-default" role="form" action="{{ route('reviews.store') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control rounded" rows="4" name="comment" placeholder="{{ translate('Share details of your own experience about this product')}}" required></textarea>
                                                </div>
                    ...
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="py-3 mb-3" style="padding: 0 5px;">
                            <div class="row gutters-5 related_product_holder">
                                @foreach (filter_products(\App\Models\Product::where('category_id', $detailedProduct->category_id)->where('id', '!=', $detailedProduct->id))->orderByRaw("RAND()")->limit(6)->get() as $key => $related_product)
                                <div class="carousel-box col-md-2 col-4">
                                    @if(discount_in_percentage($related_product) > 0)
                                        <div class="ribbon"><span class="ribbon4">{{ translate('OFF') }}&nbsp;{{discount_in_percentage($related_product)}}%</span></div>
                                    @endif
                                    <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                                        <div class="product_image_holder">
                                            <a href="{{ route('product', $related_product->slug) }}" class="d-block">
                                                <img
                                                    class="img-fit lazyload mx-auto h-sm-auto h-md-215px"
                                                    src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                        ...
                                        <div class="py-2 px-1 text-center releted_product_info">
                                            ...
                                            <div class="fs-15 releted_product_price pt-2">
                                                ...
                                                @endif
                                                <span class="fw-700 text-secondary">{{ home_discounted_base_price($related_product) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('script')
    <script type="text/javascript">
        ...
        // dynamic updating
        const ratingCounts = {
            fiveStars: Number('{{ $detailedProduct->fiveStarsCount->count() ?? 0 }}'),
            fourStars: Number('{{ $detailedProduct->fourStarsCount->count() ?? 0 }}'),
            threeStars: Number('{{ $detailedProduct->threeStarsCount->count() ?? 0 }}'),
            twoStars: Number('{{ $detailedProduct->twoStarsCount->count() ?? 0 }}'),
            oneStar: Number('{{ $detailedProduct->oneStarsCount->count() ?? 0 }}')
        };
