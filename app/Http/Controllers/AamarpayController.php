...
class AamarpayController extends Controller
{
    ...
    public function apisuccess(Request $request){
        ...
        if ($payment_type == 'cart_payment') {
            $checkoutController = new CheckoutController;
            return $checkoutController->checkout_doneapi($request->opt_b, json_encode($request->all()));
        }
    ...
    public function fail(Request $request){
        Log::channel('aamarpaylog')->info(json_encode($request->all()));
        flash(('Payment failed'))->error();
    	return redirect()->route('cart');
    }

    public function done_api(){
        return view('frontend.success_aamarpay');
    }
}
