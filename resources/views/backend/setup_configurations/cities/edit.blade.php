          ...
          <div class="card-body p-0">
              ...
              <form class="p-4" action="{{ route('cities.update', $city->id) }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group mb-3">
                      ...
                      <input type="text" placeholder="{{ ('Name')}}" value="{{ $city->getTranslation('name', $lang) }}" name="name" class="form-control" required>
                  </div>
                  ...
                  <div class="form-group mb-3" style="display: none">
                      ...
                      <input type="number" min="0" step="0.01" placeholder="{{ ('Cost')}}" name="cost" class="form-control" value="{{ $city->cost }}" required>
                  </div>
