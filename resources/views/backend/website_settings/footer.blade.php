    					...
    					<div class="card-body">
    						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    			                ...
    			                <div class="form-group">
    								...
    								<textarea class="aiz-text-editor form-control" name="about_us_description" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo","codeview"]]]' placeholder="Type.." data-min-height="150">
                ...
                <div class="card shadow-none bg-light">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                  			...
                  			<textarea class="aiz-text-editor form-control" name="frontend_copyright_text" data-buttons='[["font", ["bold", "underline", "italic"]],["insert", ["link"]],["view", ["undo","redo","codeview"]]]' placeholder="Type.." data-min-height="150">
