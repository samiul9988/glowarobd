...
<div class="row">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-3">
                            <label class="control-label">{{ ('System Default Currency')}}</label>
                        </div>
                        <div class="col-lg-6">
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{ ('Set Currency Formats')}}</h5>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST">
                    @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            <label class="control-label">{{ ('Symbol Format')}}</label>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            <label class="control-label">{{ ('No of decimals')}}</label>
                        </div>
                        <div class="col-lg-6">
        ...
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
                    ...
                    <th>{{ ('Currency name')}}</th>
                    <th data-breakpoints="lg">{{ ('Currency symbol')}}</th>
                    <th data-breakpoints="lg">{{ ('Currency code')}}</th>
