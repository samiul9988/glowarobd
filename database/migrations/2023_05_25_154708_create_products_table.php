...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->double('min_order_amount', 20, 2)->default(0);
            ...
            $table->integer('preorder_start_date')->nullable();
            $table->integer('preorder_end_date')->nullable();
            $table->integer('preorder_max_qty')->default(0);
            $table->mediumText('note')->nullable();
            $table->double('app_discount', 20, 0)->nullable()->default(0);
            $table->string('app_discount_type', 155)->nullable();
            $table->integer('app_discount_start_date')->nullable();
            $table->integer('app_discount_end_date')->nullable();
        });
    }
