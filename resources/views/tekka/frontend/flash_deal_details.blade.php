...
@section('meta')
<x-seo :meta="[
    'title' => $flash_deal->meta_title ?? $flash_deal->title,
    'description' => $flash_deal->meta_description ?? '',
    'twitter' => [
        'card' => 'product',
    ]
]" />
...
@section('content')
    ...
    <div class = "" style="background-color:{{ $flash_deal->background_color }}">
        <section class="text-center mb-3 flash_banner_sec">
            <img
                src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                data-src="{{ uploaded_asset($flash_deal->desktop_banner) }}"
        ...
        <section class="pb-4">
            <div class="container">
                <div class="text-center my-4 text-{{ $flash_deal->text_color }}">
                    <h1 class="h2 fw-600" style="color: #1b1b28">{{ $flash_deal->title }}</h1>
                ...
                <div class="row gutters-5 row-cols-xxl-6 row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-3">
