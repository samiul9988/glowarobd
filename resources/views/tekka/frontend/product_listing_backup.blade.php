                            ...
                            <div class="d-block d-xl-flex align-items-center">
                                <div class="cat_title_holder">
                                    <h1 class="h6 fw-600 text-body">
                                        ...
                                        @else
                                            {{ ('All Products') }} {{ Route::currentRouteName() == 'products.brand' ? 'by brand' : (Route::currentRouteName() == 'products.tags' ? 'by tag' : '') }}
                                            <br>
                                            @if(isset($tag))
                                                <div class="btn-group btn-group-sm mt-2" role="group" aria-label="Filter">
                                ...
                                <div class="form-group w-200px ml-0 ml-xl-3 sort_by_holder">
                                    ...
                                    <select class="form-control form-control-sm aiz-selectpicker" name="sort_by" onchange="filter()">
                                        <option value="stock-desc" @isset($sort_by) @if ($sort_by == 'stock-desc') selected @endif @endisset>{{ ('Featured')}}</option>
                                        <option value="newest" @isset($sort_by) @if ($sort_by == 'newest') selected @endif @endisset>{{ ('Newest')}}</option>
                                        <option value="oldest" @isset($sort_by) @if ($sort_by == 'oldest') selected @endif @endisset>{{ ('Oldest')}}</option>
                                        <option value="price-asc" @isset($sort_by) @if ($sort_by == 'price-asc') selected @endif @endisset>{{ ('Price low to high')}}</option>
                                        <option value="price-desc" @isset($sort_by) @if ($sort_by == 'price-desc') selected @endif @endisset>{{ ('Price high to low')}}</option>
                                    </select>
                                </div>
