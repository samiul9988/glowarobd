...
<link rel="apple-touch-icon" type="image/png" href="https://www.glowarobd.com/public/uploads/all/TCD61fFkPTAe10aKfbXaoaWYvNPJtPNBlDEwiWMd.png">
<meta name="apple-mobile-web-app-title" content="CodePen">

<link rel="shortcut icon" type="image/x-icon" href="https://www.glowarobd.com/public/uploads/all/TCD61fFkPTAe10aKfbXaoaWYvNPJtPNBlDEwiWMd.png">

<link rel="mask-icon" type="image/x-icon" href="https://www.glowarobd.com/public/uploads/all/TCD61fFkPTAe10aKfbXaoaWYvNPJtPNBlDEwiWMd.png" color="#111">


  <title>Glowaro - Under Maintenance</title>
    ...
    <main>
      <svg viewBox="0 0 100 68">
        <g id="large">
          ...
          <animateTransform attributeName="transform" begin="0s" dur="4.5s" from="0 31 37" repeatCount="indefinite" to="360 31 37" type="rotate"></animateTransform>
        </g>
        <g id="small">
          ...
          <animateTransform attributeName="transform" begin="0s" dur="3s" from="0 78 21" repeatCount="indefinite" to="-360 78 21" type="rotate"></animateTransform>
        </g>
      </svg>
