...
class ShopController extends Controller
{
    ...
    public function create()
    {
        if(Auth::check() && Auth::user()->user_type == 'admin'){
            flash(('Admin can not be a seller'))->error();
            return back();
        }
        else{
    ...
    public function store(Request $request)
    {
        ...
        if(!Auth::check()){
            ...
            if($request->password == $request->password_confirmation){
                ...
                flash(('Sorry! Password did not match.'))->error();
                return back();
            }
        }
        else{
        ...
        if(Shop::where('user_id', $user->id)->first() == null){
            ...
            if($shop->save()){
                ...
                flash(('Your Shop has been created successfully!'))->success();
    ...
    public function verify_form(Request $request)
    {
        if(Auth::user()->seller->verification_info == null){
            ...
            flash(('Sorry! You have sent verification request already.'))->error();
            return back();
        }
    }
    ...
    public function verify_form_store(Request $request)
    {
        ...
        if($seller->save()){
            flash(('Your shop verification request has been submitted successfully!'))->success();
