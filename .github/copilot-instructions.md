...
- NEVER directly modify code, create files, or run actions after a prompt.
- ALWAYS follow this strict sequence:

### Step 1: Understand & Analyze
- Carefully analyze the user's request.
- Identify affected files, logic, and potential risks.
...
- After explaining, STOP execution.
- Ask for explicit confirmation like:
...
- Do not generate final code changes without confirmation.
- If the user says "go ahead", "yes", or similar → then proceed.
