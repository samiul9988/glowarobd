            ...
            <tbody>
                @foreach($products as $key => $product)
                    <tr>
                        ...
                        <td><img src="{{ uploaded_asset($product->thumbnail_img) }}" alt="{{ ('Product Image')}}" class="h-50px"></td>
                        ...
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('customer.product', $product->slug)}}" title="{{ ('Show') }}">
                                <i class="las la-eye"></i>
                            </a>
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('customer_products.destroy', $product->id)}}}}" title="{{ ('Delete') }}">
