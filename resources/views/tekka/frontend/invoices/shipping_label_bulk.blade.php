                ...
                <tr>
                    <td style="text-align:center;"> @php
                        ...
                        echo '<img src="data:image/png;base64,' .
                            base64_encode($generator->getBarcode($order->code, $generator::TYPE_CODE_128, 1)) .
                            '">';
                    @endphp
                        <br>
                        ...
                        <table class="padding text-left small border-bottom" style="width: 60%">
                            <tr>
                                <td>
                                    ...
                                    <br>
                                    <strong>{{ ('Phone') }}:</strong> {{ get_setting('contact_phone') }}
                                    <br>
                                    <strong>{{ ('Email') }}:</strong> {{ get_setting('contact_email') }}
                                    <br>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <strong>{{ ('Email') }}:</strong> {{ $shipping_address->email }}
                                    <br>
