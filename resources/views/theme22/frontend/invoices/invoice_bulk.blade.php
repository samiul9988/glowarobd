		...
		<table>
			<tr>
				...
				<td class="text-center mx-auto" style="width: 30%;">
					...
					<img class="img-fit lazyload text-center mx-auto" src="{{ uploaded_asset(@$order->user->customeringroup->group->group_image) }}" alt="{{ @$order->user->customeringroup->group->group_name }}" style="width: 50px;">
					@endif --}}
				...
				@foreach ($order->orderDetails as $key => $orderDetail)
                    ...
                    @if ($orderDetail->product != null)
                        <tr class="">
                            ...
                            <td class="bg-danger rounded-circle">
