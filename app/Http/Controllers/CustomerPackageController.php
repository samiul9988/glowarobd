...
class CustomerPackageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        flash(('Package has been inserted successfully'))->success();
    ...
    public function update(Request $request, $id)
    {
        ...
        flash(('Package has been updated successfully'))->success();
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        flash(('Package has been deleted successfully'))->success();
        return redirect()->route('customer_packages.index');
    }
    ...
    public function purchase_package(Request $request)
    {
        ...
        if ($customer_package->amount == 0) {
            ...
            if ($user->customer_package_id != $customer_package->id) {
                ...
                flash(('You can not purchase this package anymore.'))->warning();
                return back();
            }
        }
    ...
    public function purchase_payment_done($payment_data, $payment)
    {
        ...
        flash(('Package purchasing successful'))->success();
    ...
    public function purchase_package_offline(Request $request)
    {
        ...
        $customer_package->save();
        flash(('Offline payment has been done. Please wait for response.'))->success();
