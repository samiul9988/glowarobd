...
@section('meta')
<x-seo :meta="[
    'title' => $customer_product->meta_title,
    'description' => $customer_product->meta_description,
    'keywords' => $customer_product->tags,
    'image' => $customer_product->meta_img,
    'twitter' => [
        'card' => 'product',
    ]
]">
    ...
    <meta property="product:price:amount" content="{{ single_price($customer_product->unit_price) }}">
</x-seo>
@endsection
