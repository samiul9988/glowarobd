                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="input-group">
                                <input type="number" lang="en" min="0" step="0.01" value="{{ get_setting('vendor_commission') }}" placeholder="{{ ('Seller Commission')}}" name="vendor_commission" class="form-control">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        <li class="list-group-item text-muted">
                            1. {{ get_setting('vendor_commission') }}% {{ ('of seller product price will be deducted from seller earnings') }}.
                        </li>
                        <li class="list-group-item text-muted">
