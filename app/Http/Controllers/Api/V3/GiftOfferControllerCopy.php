...
class GiftOfferControllerCopy extends Controller
{
     ...
     */
    public function getOffersForCart(Request $request, $userId)
    {
     ...
     */
    public function getSelections(Request $request, $userId)
    {
    ...
    public function selectGift(Request $request)
    {
        ...
        $selections = $this->giftOfferService->getFormattedSelections($request->user_id);
    ...
    public function removeSelection(Request $request, $selectionId)
    {
        ...
        $result = $this->giftOfferService->removeSelection($request->user_id, (int) $selectionId);
    ...
    public function clearSelections(Request $request)
    {
        ...
        $this->giftOfferService->clearSelections($request->user_id);
     ...
     */
    public function getCartWithGifts(Request $request, $userId)
    {
