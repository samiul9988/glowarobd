        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            <div class="d-flex justify-content-around align-items-center align-items-stretch">
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        <a class="btn btn-icon btn-circle btn-light" href="{{ env('FRONTEND_URL') }}" target="_blank" title="{{ ('Browse Website') }}">
            ...
            @if (addon_is_activated('pos_system'))
                <div class="d-flex justify-content-around align-items-center align-items-stretch ml-3">
                    <div class="aiz-topbar-item">
                        <div class="d-flex align-items-center">
                            <a class="btn btn-icon btn-circle btn-light" href="{{ route('poin-of-sales.index') }}" target="_blank" title="{{ ('POS') }}">
        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-lg py-0">
                        ...
                        <div class="px-3 c-scrollbar-light overflow-auto " style="max-height:300px;">
                            <ul class="list-group list-group-flush">
                                {{-- @forelse(Auth::user()->unreadNotifications()->limit(20)->get() as $notification) --}}
                                            ...
                                            <div class="media-body">
                                                @if($notification->type == 'App\Notifications\OrderNotification')
                                                    <p class="mb-1 text-truncate-2">
                                                        {{ ('Order code: ')}} {{$notification->data['order_code']}} {{ ('has been '. ucfirst(str_replace('_', ' ', $notification->data['status'])))}}
                                                    </p>
            ...
            <div class="aiz-topbar-item ml-2">
                <div class="align-items-stretch d-flex dropdown " id="lang-change">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-xs">
                        ...
                        @foreach (collect($languages) as $key => $language)
                            @php $language = (object) $language; @endphp
                            <li>
            ...
            <div class="aiz-topbar-item ml-2">
                <div class="align-items-stretch d-flex dropdown">
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="d-none d-md-block">
                                ...
                                <span class="d-block small opacity-60">
                                    @if(Auth::user()->staff?->role?->name)
                                        {{ ucwords(Auth::user()->staff?->role?->name) }}
                                    @else
                    ...
                    @php
                        $profileUrl = match (Auth::user()->user_type) {
                            'staff' => route('staffs.show', encrypt(Auth::user()->staff->id)),
