@php
$user_field = Auth::check() ? 'user_id' : 'temp_user_id';
$user_id = Auth::check() ? Auth::id() : session()->get('temp_user_id');
$cart = \App\Models\Cart::whereNotNull($user_field)->where($user_field, $user_id)->get();
@endphp
