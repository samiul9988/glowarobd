...
<form class="" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data"
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group row">
                <label class="col-lg-3 col-from-label">{{translate('Short Description')}}</label>
                <div class="col-lg-9">
                    <textarea class="aiz-text-editor"
                        name="description">{{$product->getTranslation('short_description',$lang)}}</textarea>
                </div>
            </div>
            <div class="form-group row">
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{translate('Product Note')}}</h5>
            </div>
            <div class="card-body">
                <div class="form-group mb-3">
                    <label for="name">
                        {{translate('Note About This Product')}}
                    </label>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">
                    {{translate('Pre-order Configuration')}}
                </h5>
            </div>

            <div class="card-body">
                <div class="form-group row">
                    <label class="col-md-4 col-from-label">{{translate('Pre-Order')}}</label>
                    <div class="col-md-8">
                        <label class="aiz-switch aiz-switch-success mb-0">
                ...
                <div class="form-group row">
                    <label class="col-md-4 control-label" for="start_date">{{translate('Pre-order Date Range')}}</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control aiz-date-range" name="preorder_date_range" @if($product->preorder_start_date && $product->preorder_end_date) value="{{ $preorderstart_date.' to '.$preorderend_date }}" @endif placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                    </div>
                </div>

                <div class="form-group row">
                    <label class="col-md-4 col-from-label">{{translate('Max Pre-Order Qty')}} <span class="text-danger">*</span></label>
                    <div class="col-md-8">
                ...
                <div class="form-group row">
                    <label class="col-md-4 col-from-label">{{translate('Pre-Order Qty Left')}}</label>
                    <div class="col-md-8">
