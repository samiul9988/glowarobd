      ...
      <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{ ('Shop Settings')}}
                <a href="{{ route('shop.visit', $shop->slug) }}" class="btn btn-link btn-sm" target="_blank">({{ ('Visit Shop')}})<i class="la la-external-link"></i>)</a>
            </h1>
        </div>
      </div>
    </div>
        ...
        <div class="card-body">
            <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-3" placeholder="{{ ('Phone')}}" name="phone" value="{{ $shop->phone }}" required>
                    </div>
                </div>
                <div class="row">
                ...
                @if (get_setting('shipping_type') == 'seller_wise_shipping')
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="number" lang="en" min="0" class="form-control mb-3" placeholder="{{ ('Shipping Cost')}}" name="shipping_cost" value="{{ $shop->shipping_cost }}" required>
                        </div>
                    </div>
                @endif 
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-3" placeholder="{{ ('Meta Title')}}" name="meta_title" value="{{ $shop->meta_title }}" required>
                    </div>
                </div>
                <div class="row">
            ...
            <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-box-content p-3">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" placeholder="{{ ('Facebook')}}" name="facebook" value="{{ $shop->facebook }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" placeholder="{{ ('Twitter')}}" name="twitter" value="{{ $shop->twitter }}">
                            <small class="text-muted">{{ ('Insert link with https ') }}</small>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" placeholder="{{ ('Google')}}" name="google" value="{{ $shop->google }}">
                            <small class="text-muted">{{ ('Insert link with https ') }}</small>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" placeholder="{{ ('Youtube')}}" name="youtube" value="{{ $shop->youtube }}">
                            <small class="text-muted">{{ ('Insert link with https ') }}</small>
                        </div>
                    </div>
                </div>
