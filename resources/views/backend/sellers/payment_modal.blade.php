<form action="{{ route('commissions.pay_to_seller') }}" method="POST">
    ...
    <div class="modal-body">
      ...
      @if ($seller->admin_to_pay > 0)
          <div class="form-group row">
              <label class="col-md-3 col-from-label" for="amount">{{ ('Amount')}}</label>
              <div class="col-md-9">
          ...
          <div class="form-group row">
              <label class="col-md-3 col-from-label" for="payment_option">{{ ('Payment Method')}}</label>
              <div class="col-md-9">
          ...
          <div class="form-group row" id="txn_div">
              <label class="col-md-3 col-from-label" for="txn_code">{{ ('Txn Code')}}</label>
              <div class="col-md-9">
    ...
    <div class="modal-footer">
      ...
      @else
          <button type="submit" class="btn btn-primary">{{ ('Clear due')}}</button>
      @endif
