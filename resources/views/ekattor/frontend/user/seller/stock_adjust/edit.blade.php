...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{translate('Edit Stock Adjust')}}</h5>
</div>
<div class="">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="sa_type" id="sa_type" data-live-search="true" required>
                                    ...
                                    <option value="returned" @if($stock_adjust->sa_type == 'returned')selected @endif>Returned</option>
                                    <option value="others" @if($stock_adjust->sa_type == 'others')selected @endif>Others</option>
                                </select>
                        ...
                        <div class="form-group row">
	                        <label class="col-sm-3 control-label" for="sa_date">{{translate('Date')}}</label>
	                        <div class="col-sm-3">
	                          <input type="date" class="form-control" name="sa_date" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off" value="{{ date('Y-m-d',$stock_adjust->sa_date)}}">
	                        </div>
	                    </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Purchase Order Items')}}</h5>
                    </div>
                    <div class="card-body">
