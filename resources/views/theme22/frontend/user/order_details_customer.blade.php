<div class="modal-header border-0" style="padding-left: 10px">
    ...
    <h6 class="modal-title font-weight-bold text-center text-secondary" id="exampleModalLabel">{{ ('Order Details')}}</h6>
...
<div class="d-none d-md-block">
    <div class="py-4">
        <div class="row gutters-5 text-center aiz-steps">
            ...
            <div class="col @if($status == 'processing') done @else done @endif">
                <div class="icon">
                    <i class="las la-spinner" style="font-size: 20px"></i>
                </div>
                <div class="title fs-12">{{ ('Processing')}}</div>
            </div>

            <div class="col @if($status == 'hold') done @else done @endif">
                <div class="icon">
                    <i class="las la-stopwatch" style="font-size: 20px"></i>
                </div>
                <div class="title fs-12">{{ ucfirst(translate('Hold')) }}</div>
            </div>
...
<div class="d-block d-md-none">
    <div class="timeline_container">
        ...
        <div class="timeline-block timeline-block-right">
            <div class="timeline_left_content">
                <div class="">
                    <i class="las la-spinner text-black-50" style="font-size: 20px"></i>
                </div>
            </div>
           <div class="timeline-content">
              <h3>Processing</h3>
           </div>
           <div class="marker @if($status == 'processing') active @else active @endif"><i class="fa fa-check" aria-hidden="true"></i></div>
        </div>

        <div class="timeline-block timeline-block-right">
            <div class="timeline_left_content">
                <div class="">
                    <i class="las la-stopwatch text-black-50" style="font-size: 20px"></i>
                </div>
            </div>
           <div class="timeline-content">
              <h3>Hold</h3>
           </div>
           <div class="marker @if($status == 'hold') active @else active @endif"><i class="fa fa-check" aria-hidden="true"></i></div>
        </div>
        ...
        <div class="card-body p-2">
            <div class="row">
                ...
                <div class="col-6 text-right">
                    <p><span class="font-weight-bold">{{ ('Shipping method:')}}</span><br><span>{{ @$order->orderDetails[0]->shippingMethod->name }}<br/>
                        {{ ('Flat shipping rate')}}</span></p>
    ...
    <div class="col-12 mt-3">
        <div class="row">
            <div class="col-8 text-right">
                <p class="fw-600">{{ ('Subtotal')}}</p>
                <p class="fw-600">{{ ('Tax')}}</p>
                <p class="fw-600">{{ ('Shipping Cost')}}</p>
                <p class="fw-600">{{ ('Discount')}}</p>
                @if($order->payments->sum('amount') > 0)
                    <p class="fw-600">{{ ('Paid Amount')}}</p>
                @endif
            </div>
    ...
    <div class="col-12">
        <div class="row">
            <div class="col-8 text-right">
                <p class="fw-600">{{ ('Grand Total')}}</p>
            </div>
            <div class="col-4 text-right">
                {{-- <p class="text-danger font-weight-bold">{{ single_price($order->grand_total) }}</p> --}}
                <p class="text-danger font-weight-bold">{{ single_price(get_order_grand_total($order) - $order->payments->sum('amount')) }}</p>
            </div>
        </div>
    </div>
