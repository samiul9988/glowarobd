    ...
    {{-- <div class="py-4">
        <div class="row gutters-5 text-center aiz-steps">
            ...
            <div class="col @if($status == 'on_delivery') active @elseif($status == 'delivered') done @endif">
                ...
                <div class="title fs-12">{{ ('On delivery')}}</div>
            </div>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="form-group">
                <select class="form-control aiz-selectpicker form-control-sm"  data-minimum-results-for-search="Infinity" id="update_delivery_status">
                    ...
                    <option value="picked_up"   @if ($status == 'picked_up') selected @endif>{{ ('Picked Up')}}</option>
                    <option value="on_the_way"  @if ($status == 'on_the_way') selected @endif>{{ ('On The Way')}}</option>
                    <option value="delivered"   @if ($status == 'delivered') selected @endif>{{ ('Delivered')}}</option>
                    <option value="cancelled"   @if ($status == 'cancelled') selected @endif>{{ ('Cancel')}}</option>
                </select>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="w-50 fw-600">{{ ('Contact')}}:</td>
