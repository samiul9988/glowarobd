        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{ ('SMS Templates')}}</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-3">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                @foreach ($sms_templates as $key => $sms_template)
                                    <a class="nav-link @if($sms_template->id == 1) active @endif" id="v-pills-tab-2" data-toggle="pill" href="#v-pills-{{ $sms_template->id }}" role="tab" aria-controls="v-pills-profile" aria-selected="false">{{ (ucwords(str_replace('_', ' ', $sms_template->identifier)))  }}</a>
                                @endforeach
                            </div>
                        </div>
                        <div class="col-9">
                                    ...
                                    <div class="tab-pane fade show @if($sms_template->id == 1) active @endif" id="v-pills-{{ $sms_template->id }}" role="tabpanel" aria-labelledby="v-pills-tab-1">
                                        <form action="{{ route('sms-templates.update', $sms_template->id) }}" method="POST">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea name="body" class="form-control" placeholder="Type.." rows="6" required>{{ str_replace('\n', "\n", $sms_template->sms_body) }}</textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="template_id" value="{{ $sms_template->template_id }}" class="form-control" placeholder="{{ ('Template Id')}}">
