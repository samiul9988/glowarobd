<div class="card mb-0 border-0 shadow-sm rounded">
    <div class="card-header">
        <h3 class="fs-16 fw-600 mb-0">{{ ('Your Cart Summary')}}</h3>
                ...
                <div class="mt-3">
                    <form class="" id="remove-coupon-form" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="button" id="coupon-remove" @click="removeCoupon($event.target)" class="btn btn-primary">{{ ('Change Coupon')}}</button>
                            </div>
                        </div>
                    </form>
