                    ...
                    <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
                        <div class="px-3 pt-3">
                            <div class="opacity-50">
                                <span class="fs-12 d-block">{{ 'Confirm' }}</span>
                                {{ 'Orders' }}
                            </div>
                            <div class="h3 fw-700 mb-3">
                                {{ data_get($report, 'confirmed_orders_count', 0) }}
                            </div>
                        </div>
        ...
        <div class="col-lg-4">
            <div class="row gutters-10">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="mb-0 fs-14">{{ 'Orders Logs' }}</h6>
                        </div>
                        <div class="card-body">
                            <canvas id="orders-logs-pie" class="w-100" height="305"></canvas>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="row gutters-10">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="mb-0 fs-14">{{ 'Products Logs' }}</h6>
                        </div>
                        <div class="card-body">
                            <canvas id="products-logs-pie" class="w-100" height="305"></canvas>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    ...
    <script>
        AIZ.plugins.chart('#orders-logs-pie', {
            type: 'doughnut',
            data: {
                labels: [
                    '{{ 'Cancelled' }}',
                ...
                datasets: [{
                    data: [
                        {{ data_get($report, 'cancelled_orders_count', 0) }},
                        {{ data_get($report, 'delivered_orders_count', 0) }},
                        {{ data_get($report, 'returned_orders_count', 0) }}
                    ],
                    backgroundColor: [
                        "#fd3995",
                        "#34bfa3",
        ...
        AIZ.plugins.chart('#products-logs-pie', {
            type: 'doughnut',
            data: {
                labels: [
                    '{{ 'Published' }}',
                ...
                datasets: [{
                    data: [
                        {{ data_get($report, 'published_products_count', 0) }},
                        {{ data_get($report, 'unpublished_products_count', 0) }},
                        {{ data_get($report, 'out_of_stock_products_count', 0) }}
                    ],
                    backgroundColor: [
                        "#fd3995",
                        "#34bfa3",
