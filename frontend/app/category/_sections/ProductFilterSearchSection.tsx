...
import FilterSearchDrawerMobile from "../_components/FilterSearchDrawerMobile";
import FilterSearchInlineWidgets from "@/app/search/_components/filter/FilterSearchInlineWidgets";
import SortBySelectSearchOption from "../_components/filter/SortBySelectSearchOption";
...
const ProductFilterSearchSection = () => {
  const { data, isLoading, isFetching } = useSearchProducts();
  const { page, setSearchFilter } = useSearchStore();
  ...
  useEffect(() => {
    ...
    if (page === 1) {
      setProducts(data.data); // reset on first page
    } else {
  ...
  }, [inView, hasMore, isFetching, page, setSearchFilter]);
        ...
        <div className="flex-1">
          <div className="mb-6 flex items-center justify-between gap-4">
            <div className="flex flex-1 items-center gap-3">
              <FilterSearchInlineWidgets />
              <SortBySelectSearchOption />
...
export default ProductFilterSearchSection;
