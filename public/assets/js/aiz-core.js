...
(function ($) {
    ...
    AIZ.uploader = {
        ...
        getAllUploads: function (url, search_key = null, sort_key = null) {
            ...
            params["type"] = AIZ.uploader.data.type;
    ...
    AIZ.plugins = {
            ...
            if ($("#aiz-upload-files").length > 0) {
                var uppy = Uppy.Core({
                    ...
                    onBeforeFileAdded: function (currentFile, files) {
                        var name = currentFile.name || "file";
                        var base = name;
                        var ext = "";
                        ...
                        var existingNames = Object.keys(files).map(function (id) {
                        ...
                        return Object.assign({}, currentFile, { name: newName });
                    },
                });
                    ...
                    $this
                        ...
                        .on("update.countdown", function (event) {
                            var $this = $(this).html(
                                event.strftime(
                                    "" +
                                        '<div class="countdown-item"><span class="countdown-digit">%-D</span><span class="countdown-digit-text">Days</span></div>' +
                                        '<div class="countdown-item"><span class="countdown-digit">%H</span><span class="countdown-digit-text">Hours</span></div>' +
                                        '<div class="countdown-item"><span class="countdown-digit">%M</span><span class="countdown-digit-text">Min</span></div>' +
                                        '<div class="countdown-item"><span class="countdown-digit">%S</span><span class="countdown-digit-text">Sec</span></div>'
                                )
                            );
                        });
                });
        ...
        slickCarousel: function () {
            $(".aiz-carousel")
                ...
                .each(function () {
                    ...
                    var unSlickXl = $this.data("unslick-xl");
                    var unSlickLg = $this.data("unslick-lg");
                    var unSlickMd = $this.data("unslick-md");
                    var unSlickSm = $this.data("unslick-sm");
                    var unSlickXs = $this.data("unslick-xs");
                    ...
                    unSlickSm = !unSlickSm ? false : unSlickSm;
        ...
        lbtLightbox: function(){
            $('.lbt-gallery').each(function() {
                var $this = $(this);
                $this.lbtLightBox({
                    td_pagination: 6,
                    pagination_width: "160px",
                    pagination_height: "160px",
                    custom_children: ".lbt-box img",
                    captions: true,
    ...
    AIZ.extra = {
        ...
        plusMinus: function(){
            $('.aiz-plus-minus input').each(function() {
                ...
                var isEdit = $(this).attr("data-edit") ? true : false;
                if(value <= min){
            ...
            $('.aiz-plus-minus button').on('click', function(e) {
                ...
                var input = $(`.inputCart-${pid}`);
                var currentVal = parseInt(input.val());
                var isEdit = input.attr("data-edit") ? true : false;
        ...
        // hovHomeCategoryMenu: function(){
        //     $("#category-home-menu-icon, #category-sidebar")
        //         .on("mouseover", function (event) {
        //             $("#hover-home-category-menu").addClass('active').removeClass('d-none');
        //         })
        //         .on("mouseout", function (event) {
        //             $("#hover-home-category-menu").addClass('d-none').removeClass('active');
        //         });
        // },
        trimAppUrl: function(){
