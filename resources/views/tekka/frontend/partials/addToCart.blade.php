        ...
        <div class="col-lg-6">
            <div class="text-left">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-10">
                                <div class="product-quantity d-flex align-items-center">
                                    <div class="row no-gutters align-items-center aiz-plus-minus mr-3 px-2 py-1 rounded-lg" style="width: 130px;">
                                        ...
                                        <input type="text" name="quantity" class="col border-0 text-center flex-grow-1 fs-16 input-number inputCart-{{$product->id}}" placeholder="1" value="{{ $product->min_qty }}" min="{{ $product->min_qty }}" max="10">
                ...
                <div class="mt-3">
                    ...
                    @elseif($qty > 0)
                        @if ($product->external_link != null)
                            <a type="button" class="btn btn-soft-primary mr-2 add-to-cart fw-600" href="{{ $product->external_link }}">
                                ...
                                <span class="d-none d-md-inline-block">{{ ($product->external_link_btn)}}</span>
                            </a>
                        @else
                            <button type="button" class="btn btn-primary buy-now fw-600 add-to-cart" onclick="addToCart()">
                                <i class="la la-shopping-cart"></i>
                    ...
                    <br>
                    <span class="pre-order-text mt-1 text-danger small d-none">More stock arriving soon. Pre-Order now and secure your's!</span>
                </div>
