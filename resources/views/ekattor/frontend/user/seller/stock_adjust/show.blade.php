...
<div class="card">
    <div class="card-header">
        <h1 class="h2 fs-16 mb-0">{{ translate('Stock Adjust Details') }}</h1>
    </div>
    <div class="card-body">
                ...
                <table class="table table-bordered invoice-summary">
                    <thead>
                        <tr class="bg-trans-dark">
                            ...
                            <th data-breakpoints="lg" class="min-col text-right text-uppercase">{{translate('Variant')}}</th>
                            <th data-breakpoints="lg" class="min-col text-right text-uppercase">{{translate('SKU')}}</th>
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="5">{{translate('Total Quantity')}} :</th>
