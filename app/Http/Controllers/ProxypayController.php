...
//                return $checkoutController->checkout_done(Session::get('order_id'), $payment_detalis);
            ...
            elseif (Session::get('payment_type') == 'wallet_payment') {
                flash(('Your request for wallet recharge has been accepted. Kindly pay on proxypay to confirm.'))->success();
                return back();
            }
            elseif (Session::get('payment_type') == 'customer_package_payment') {
                flash(('Your request for customer package has been accepted. Kindly pay on proxypay to confirm.'))->success();
                return back();
            }
            elseif (Session::get('payment_type') == 'seller_package_payment') {
