...
<form class="" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data"
    ...
    <div class="row gutters-5">
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-lg-3 col-from-label">{{ ('Product Name')}}</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="name"
                                placeholder="{{ ('Product Name')}}" value="{{$product->getTranslation('name',$lang)}}"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-from-label">{{ ('Unit')}}</label>
                        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                {{-- <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{ ('Thumbnail Image')}}
                <small>(290x300)</small></label>
                <div class="col-lg-8">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <label class="col-lg-3 col-from-label" for="start_date">{{ ('Discount Date Range')}}</label>
                <div class="col-lg-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    <input type="number" lang="en" min="0" step="0.01" placeholder="{{ ('Discount')}}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="number" lang="en" value="{{ $product->stocks->first()->qty }}" step="1"
                            placeholder="{{ ('Quantity')}}" name="current_stock" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group row">
                <label class="col-lg-3 col-from-label">{{ ('Short Description')}}</label>
                <div class="col-lg-9">
